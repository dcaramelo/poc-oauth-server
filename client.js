...
client.getAccessToken = function (bearerToken, callback) {
...
client.getRefreshToken = function (bearerToken, callback) {
...
client.grantTypeAllowed = function (clientId, grantType, callback) {
    callback(false, authorizedClientIds[grantType] &&
        authorizedClientIds[grantType].indexOf(clientId.toLowerCase()) >= 0);
};

client.saveAccessToken = function (accessToken, clientId, expires, userId, callback) {
...
client.saveRefreshToken = function (refreshToken, clientId, expires, userId, callback) {
 ...
 */
client.getUser = function (username, password, callback) {
